...
### 🎴 The mflash Stack
A cohesive suite dedicated to customizable, offline spaced-repetition learning formats.
* **[mflash-spec](https://github.com/MoribundMurdoch/mflash-spec)** - Official specification, schemas, and multilingual flashcard migration tools.
* **[moribund-flash](https://github.com/MoribundMurdoch/moribund-flash)** - Lightweight offline flashcard app built with Tauri, Rust, and vanilla JavaScript.
...
* **[morconcat](https://github.com/MoribundMurdoch/morconcat)** - Fast native Rust utility to merge CSS, Markdown, Rust, and JS into single files.
* **[mor-steg-cli](https://github.com/MoribundMurdoch/mor-steg-cli)** - Lazy-friendly CLI wrapper for age-encrypted steganography with steghide.
* **[mor-rust-code-gui-manager](https://github.com/MoribundMurdoch/mor-rust-code-gui-manager)** - Dioxus-powered graphical interface for inspecting project structures.
...
*Want to take over a project or collaborate? Just ask. Must stay open source.*
